...
static void _STREAMER_Tasks(void);
static void _WS_SERVER_Tasks(void);
...
void SYS_Tasks ( void )
{
    ...
    /* Create OS Thread for STREAMER Tasks. */
    xTaskCreate((TaskFunction_t) _STREAMER_Tasks,
                "STREAMER Tasks",
                1024, NULL, 1, NULL);

    /* Create OS Thread for WS_SERVER Tasks. */
    xTaskCreate((TaskFunction_t) _WS_SERVER_Tasks,
                "WS_SERVER Tasks",
                1024, NULL, 1, NULL);
...
/*******************************************************************************
  Function:
    void _STREAMER_Tasks ( void )

  Summary:
    Maintains state machine of STREAMER.
*/
...
/*******************************************************************************
  Function:
    void _WS_SERVER_Tasks ( void )

  Summary:
    Maintains state machine of WS_SERVER.
*/
